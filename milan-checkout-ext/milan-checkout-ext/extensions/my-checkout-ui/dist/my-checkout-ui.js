(() => {
  ...
  // extensions/my-checkout-ui/src/Checkout.js
  var Checkout_default = extension(
    "purchase.checkout.block.render",
    (root, { lines, applyCartLinesChange, query, i18n, settings }) => {
      var _a, _b;
      let products = [];
      let loading = true;
      ...
      const title = (_a = settings.current.title) != null ? _a : "Custom banner Test";
      const description = (_b = settings.current.description) != null ? _b : "Custom banner description";
      ...
      settings.subscribe((newSettings) => {
        var _a2;
        banner.updateProps({
          title: (_a2 = newSettings.title) != null ? _a2 : "Custom banner Test",
  ...
  function updateProductComponents(product, imageComponent, titleMarkup, priceMarkup, addButtonComponent, merchandise, i18n) {
    ...
    const imageUrl = (_b = (_a = images.nodes[0]) == null ? void 0 : _a.url) != null ? _b : "https://cdn.shopify.com/s/files/1/0853/0578/6679/files/M-logo-removebg-preview.png?v=1704784372";
  ...
  // extensions/my-checkout-ui/src/DeliveryAddress.js
  var DeliveryAddress_default = extension(
    ...
    (root, api) => {
      root.appendChild(
        root.createComponent(
          ...
          "I would like to receive a free gift with my order test"
        )
      );
      function onCheckboxChange(isChecked) {
        return __async(this, null, function* () {
          const result = yield api.applyAttributeChange({
  ...
  // extensions/my-checkout-ui/src/ShippingOptioList.js
  var ShippingOptioList_default = extension(
...
//# sourceMappingURL=my-checkout-ui.js.map
