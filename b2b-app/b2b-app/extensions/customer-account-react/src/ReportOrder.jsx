import { Button, CustomerAccountAction, reactExtension, useApi, Select, Form } from "@shopify/ui-extensions-react/customer-account";
...
function MenuActionModalExtension() {
  const {close, authenticatedAccount, orderId} = useApi();
